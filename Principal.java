...
//Calculando así, el vehiculo cuyo precio es el menor de todos.
    ...
    public static void BusquedaBinariaMotos() {
    ...
    public static void ArregloPolimorficoCarro() {
    ...
    public static void ArregloPolimorficoMoto() {
    ...
    public static void ArregloAgregar()
    {
    ...
    public static void ArregloEliminar()
    {
    ...
    public static void ArregloEditar()
    {
    ...
    public static void IComparadores()
    {
        float preciomoto1;
                    float preciomoto2;
                    Motos v[] = new Motos[2];
    ...
    public static void main(String[] args) {
        ...
        while (!salida) {
            ...
            switch (respuesta) {
                ...
                case '3':
                    BusquedaSecuencialAutos();

                    break;

                case '4':
                    BusquedaBinariaMotos();
                    break;
                ...
                case 'B':
                    ArregloPolimorficoCarro();

                    break;

                case 'C':
                    ArregloPolimorficoMoto();
